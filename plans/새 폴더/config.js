...
const description = "Rug Or Ruged! Hey Degen, Try to Rug me 🚀🚀";
const baseUri =
  "https://lavender-neat-porcupine-347.mypinata.cloud/ipfs/QmUHUBZifj3YKmFPAyQfYeJzcBnWXN9NexQXzKFSNT7HCU";
...
const layerConfigurations = [
  {
    ...
    namePrefix: "Rug Or Ruged!", // Use to add a name to Metadata `name:`
    layersOrder: [
      { name: "bg" },
      { name: "slot1" },
      { name: "slot2" },
